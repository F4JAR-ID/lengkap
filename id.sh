...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR   :  Fajar Id  "$i"                    "
echo $i""$pu"  WhatsApp :  Privasi :v "$i"                "
echo $i""$pu"  Facebook :  Fajar Id"$i"     "
echo $i""$pu"  YOUTUBE  :  Fajar ID"$i"                 "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Fajar Id"
echo $ku"YouTube  :"$i" Fajar ID"
echo $ku"WhatsApp :"$i" chat Fb"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { Fajar ID }"
exit
fi
